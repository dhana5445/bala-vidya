...
CREATE TABLE IF NOT EXISTS topics (
  ...
  name TEXT NOT NULL,
  UNIQUE(subject_id, grade, chapter, name)
);
...
CREATE TABLE IF NOT EXISTS lessons (
  ...
  page_count SMALLINT NOT NULL DEFAULT 10,
...
CREATE TABLE IF NOT EXISTS progress (
  ...
  topic_id UUID NOT NULL REFERENCES topics(id),
  theory_percent SMALLINT NOT NULL DEFAULT 0,
  practice_percent SMALLINT NOT NULL DEFAULT 0,
...
CREATE INDEX IF NOT EXISTS attempts_user_completed_idx ON attempts(user_id, completed_at DESC);
